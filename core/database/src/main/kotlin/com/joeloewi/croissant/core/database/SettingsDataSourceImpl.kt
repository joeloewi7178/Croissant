...
class SettingsDataSourceImpl @Inject constructor(
...
) : com.joeloewi.croissant.core.database.SettingsDataSource {
    override fun getSettings(): Flow<com.joeloewi.croissant.core.data.model.Settings> =
        application.settingsDataStore.data.map { settingsMapper.toDomain(it) }

    override suspend fun setDarkThemeEnabled(darkThemeEnabled: Boolean): com.joeloewi.croissant.core.data.model.Settings =
    ...
    override suspend fun setIsFirstLaunch(isFirstLaunch: Boolean): com.joeloewi.croissant.core.data.model.Settings =
        withContext(Dispatchers.IO) {
            application.settingsDataStore.updateData {
    ...
    override suspend fun setNotifyMigrateToAlarmManager(notifyMigrateToAlarmManager: Boolean): com.joeloewi.croissant.core.data.model.Settings =
        withContext(Dispatchers.IO) {
            application.settingsDataStore.updateData {
