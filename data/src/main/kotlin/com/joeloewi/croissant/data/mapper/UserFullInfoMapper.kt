...
) : ReadOnlyMapper<com.joeloewi.croissant.core.data.model.UserFullInfo, UserFullInfoResponse> {

    override fun toDomain(dataEntity: UserFullInfoResponse): com.joeloewi.croissant.core.data.model.UserFullInfo =
        with(dataEntity) {
